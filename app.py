...
# نقشه تایم‌فریم‌های بالاتر (HTF)
# اینجا حتماً باید '1y' وجود داشته باشد تا وقتی کاربر '1M' را انتخاب کرد، سیستم بداند باید به '1y' نگاه کند.
HTF_MAP = {"1m": "15m", "5m": "30m", **CFG["htf_map"], "1w": "1M", "1M": "1y"}

# لیست گزینه‌های منو (اینجا '1y' حذف شده تا کاربر نتواند آن را انتخاب کند)
TF_OPTIONS = ["1m", "5m", "15m", "1h", "4h", "1d", "1w", "1M"]

# برچسب‌های نمایش (فقط برای مواردی که در TF_OPTIONS هستند)
TF_LABELS = {"1w": "هفتگی (1W)", "1M": "ماهانه (1M)"}
